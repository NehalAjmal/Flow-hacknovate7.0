...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  Widget _buildInterventionBanner(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
              color: driftColor.withValues(alpha: 0.1),
              blurRadius: 12,
              spreadRadius: 2)
        ],
      ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  "You've drifted from your intention",
                  style: TextStyle(
                      fontSize: 13,
                ...
                Text(
                  "Context drift is normal. Your session goal was \"Debug auth module\" — want to return?",
  ...
  Widget _buildRhythmSegment(BuildContext context,
      {bool isTrough = false,
      bool isPeak = false,
    ...
    if (isTrough) {
      ...
      bgColor = theme.brightness == Brightness.dark
          ? FlowTheme.primaryStrongDark
          : FlowTheme.primaryStrongLight;
  ...
  Widget _buildCalDay(BuildContext context, String name, String num,
      {bool isActive = false, bool hasEvent = false}) {
    final theme = Theme.of(context);
    return Expanded(
      child: Container(
  ...
  Widget _buildTimelineItem(BuildContext context, String emoji, String title,
      String time, bool isGreen, bool isOrange,
      {bool isLast = false}) {
    final theme = Theme.of(context);
    Color dotBg = isGreen
  ...
  Widget _buildAppRow(BuildContext context, String emoji, String name,
      String time, double progress, Color iconBg, Color barColor) {
    return Padding(
