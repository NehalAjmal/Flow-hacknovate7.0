  ...
  Future<void> _fetchLiveData() async {
    try {
      ...
      if (responses[0].statusCode == 200 && responses[1].statusCode == 200) {
        if (!mounted) return;
        setState(() {
          _dashData = DashboardData.fromJson(jsonDecode(responses[0].body));
          _bioData = BiometricData.fromJson(jsonDecode(responses[1].body));
          _isLoading = false;
        });
        _ringEntry.forward();
      }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Conditionally show the intervention banner if they are stuck or fatigued
            if (_dashData?.currentState == "FATIGUE" || _dashData?.currentState == "STUCK") ...[
  ...
  Widget _buildTopBar(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        MeetingCountdownPill(nextMeetingTime: DateTime.now().add(const Duration(minutes: 14)), meetingTitle: "Team standup"),
      ],
    );
  }
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Cognitive Loop Detected", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: driftColor)),
                const SizedBox(height: 3),
                Text("System detects high context switching. Want to take a 2-minute reset?", style: Theme.of(context).textTheme.bodySmall),
              ],
            ),
          ),
      ...
      child: Row(
        ...
        children: [
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                CountUpText(target: _dashData?.focusScore ?? 0, style: Theme.of(context).textTheme.displayLarge?.copyWith(color: Theme.of(context).primaryColor)),
                        ...
                        FocusRing(score: (_dashData?.focusScore ?? 0).toDouble(), color: Theme.of(context).primaryColor, trackColor: Theme.of(context).dividerColor),
                      ],
                    ),
          ...
          Expanded(
            ...
            child: Column(
              children: [
                _buildHeroCard(context, "SESSIONS TODAY", "3", "${(_dashData?.totalFocusMins ?? 0) ~/ 60}h ${(_dashData?.totalFocusMins ?? 0) % 60}m total focus", isGreen: true),
                          ...
                          child: Column(
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: LinearProgressIndicator(value: 0.34, minHeight: 8, backgroundColor: Theme.of(context).dividerColor, color: Theme.of(context).primaryColor),
                              ),
                              const SizedBox(height: 4),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _buildCalDay(context, "Mon", "30"), _buildCalDay(context, "Tue", "31"), _buildCalDay(context, "Wed", "1"),
                        _buildCalDay(context, "Thu", "2"), _buildCalDay(context, "Fri", "3", hasEvent: true),
                        _buildCalDay(context, "Sat", "4", isActive: true, hasEvent: true), _buildCalDay(context, "Sun", "5"),
                      ],
                    ),
                    const SizedBox(height: 20),
                    Column(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            if (hasEvent) ...[ const SizedBox(height: 4), Container(width: 4, height: 4, decoration: BoxDecoration(color: isActive ? Colors.white : theme.colorScheme.secondary, shape: BoxShape.circle)) ]
